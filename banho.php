...
<head>
    ...
    <title>Senne Tecidos | Banho</title>
    <!-- Ícone Navegador -->
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top px-5 box-shadow">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="banho.php">Banho</a>
                </li>
                <li class="nav-item">
                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img class="d-block w-100" src="images/carrossel-banho.png" alt="Primeiro Slide">
                      </div>
    ...
    <section class="py-5 bg-light text-center">
        <div class="container">
            <div class="py-3 informacao">
                <span class="h5 d-block bg-dark text-light"><b>BANHO</b></span>
            </div>

            <div class="row pt-5 text-dark anime">
                <?php
                    $consulta = $pdo->query("SELECT * FROM tb_produtos WHERE categoria='banho'");
