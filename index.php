                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img class="d-block w-100" src="images/carrossel-index.png" alt="Primeiro Slide">
                      </div>
    ...
    <section class="py-5 bg-light text-center">
        <div class="container">
            <div class="py-3 informacao">
                <span class="h5 d-block bg-dark text-light">DIVERSAS VARIEDADES DE <b>CAMA</b>, <b>MESA</b> E <b>BANHO</b></b></span>
            </div>

            <div class="row py-4 anime">
                <div class="col-md-12">
                    <a href="cama.php" style="text-decoration: none;">
                        <img class="d-block w-100 rounded box-shadow" src="images/cama.png" alt="Cama">
                        <h3 class="bg-dark text-light sobre-item">Cama</h3>
                    </a>
                </div>
            </div>
            ...
            <div class="row py-4 anime">
                <div class="col-md-12">
                    <a href="mesa.php" style="text-decoration: none;">
                        <img class="d-block w-100 rounded box-shadow" src="images/mesa.jpeg" alt="Mesa">
                        <h3 class="bg-dark text-light sobre-item">Mesa</h3>
                    </a>
                </div>
            </div>
            ...
            <div class="row py-4 anime">
                <div class="col-md-12">
                    <a href="banho.php"style="text-decoration: none;">
                        <img class="d-block w-100 rounded box-shadow" src="images/banho.jpeg" alt="Banho">
                        <h3 class="bg-dark text-light sobre-item">Banho</h3>
                    </a>
                </div>
            </div>
            ...
            <div class="row py-4 anime">
                <div class="col-md-12">
                    <a href="acessorios.php" style="text-decoration: none;">
                        <img class="d-block w-100 rounded box-shadow" src="images/acessorios.jpeg" alt="Acessórios">
                        <h3 class="bg-dark text-light sobre-item">Acessórios</h3>
                    </a>
                </div>
            </div>
        </div>
