        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 col-12">
                    <img class="d-block w-100 rounded box-shadow" src="images/<?php echo $row['imagem']; ?>">
                </div>
                <div class="col-md-6 col-12">
                    <div class="nomeProduto my-3">
                        <p class="h3 d-block text-dark text-center"><?php echo $row['nome']; ?></p>
                    </div>
                    <div class="dropdown-divider my-4"></div>
                    <div class="descricaoProduto text-center">
                        <p class="h3 d-block font-weight-bold">Descrição do Produto</p>
                        <p class="d-block text-justify text-dark"><?php echo $row['descricao']; ?></p>
                    </div>
                </div>
            </div>
        </div>
